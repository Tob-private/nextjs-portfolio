...
export const projects: ProjectInterface[] = [
  {
    ...
    content: [
      'After my education at Chas Academy concluded, I decided to learn a new framework and make something with it. That "something" turned into my first, proper portfolio website.',
  ...
  },
  {
    ...
    content: [
      "During my internship at Clira, I was tasked with improving the stability and performance of their PDF exports, as new opportunities presented themselves. As we moved to a new infrastructure, I was responsible for refactoring the system we used to generate PDFs.",
      "I consider this to be the most fun project I have been a part of, mostly because I learnt so much. I learnt about Laravel's queue, Blade Template do's and dont's, how to organize such a large rewrite and, most importantly, when to give up on my pride and ask for help.",
    ],
    tech: [
      "Next.js",
      "Laravel",
  ...
  },
  {
    ...
    content: [
      "My first real project was a group project with 3 classmates. The project's main task was to create a digital notepad website, and subsequently adding features like saving notes, creating new notes, text formatting, and more.",
      "This project served as an intro to Agile methods like Scrum, something I would use a lot in the coming years. It also showed me how important it is for a group to communicate with each other, and reach out in case you get stuck.",
    ],
