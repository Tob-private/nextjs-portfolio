...
export const projects: ProjectsInterface[] = [
  ...
  },
  {
    ...
    content:
      "During my internship at Clira, I was tasked with improving the stability and performance of their PDF exports, as new opportunities presented themselves. As we moved to a new infrastructure, I was responsible for refactoring the system we used to generate PDFs. I consider this to be the most fun project I have been a part of, mostly because I learnt so much. I learnt about Laravel's queue, Blade Template do's and dont's, how to organize such a large rewrite and, most importantly, when to give up on my pride and ask for help.",
    tech: [
      "Next.js",
      "Laravel",
      "PhP",
